...
namespace TennisBookings.Web.Tests.Controllers
{
    public class HomeControllerTests
    {
        ...
        public void ReturnsExpectedViewModel_WhenWeatherIsSun()
        {
            ...
            mockWeatherForecaster.Setup(w => w.GetCurrentWeather()).Returns(new WeatherResult { WeatherCondition = WeatherCondition.Sun });
        ...
        {
            var mockWeatherForecaster = new Mock<IWeatherForecaster>();
            mockWeatherForecaster.Setup(w => w.GetCurrentWeather()).Returns(new WeatherResult { WeatherCondition = WeatherCondition.Rain });
